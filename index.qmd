...
This is a collection of code that has been developed, reused, and refined by the Analytics for Australian Grains Industry (AAGI) network. The kind of code that often lives in personal folders but proves useful again and again in AAGI projects.
...
It may be useful for other uses case from different fields. If this is the case, we encourage you to reach out to the code custodian/maintainer for more context and collaboration. 
